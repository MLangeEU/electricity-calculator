...
label_costs = tk.Label(window, text="Strompreis in Cent/kWh:", font=("Helvetica", 15), foreground="white", background="#2E2E2E")
label_powerOutput = tk.Label(window, text="Leistung in Watt:", font=("Helvetica", 15), foreground="white", background="#2E2E2E")
label_workTime = tk.Label(window, text="Betriebszeit in Stunden:", font=("Helvetica", 15), foreground="white", background="#2E2E2E")
...
# Button to calculate
calc_button = tk.Button(window, text="Berechnen", command=berechnen, font=("Helvetica", 14), fg="white", bg="#3A3A3A", 
